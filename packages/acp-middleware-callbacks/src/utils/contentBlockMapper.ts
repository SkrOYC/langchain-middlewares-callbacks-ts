...
export class DefaultContentBlockMapper implements ContentBlockMapper {
   ...
   */
  private textFromACP(block: TextContent & { type: "text" }): LangChainContentBlock {
   ...
   */
  private imageFromACP(block: ImageContent & { type: "image" }): LangChainContentBlock {
    return {
      type: "image",
      data: block.data,
   ...
   */
  private audioFromACP(block: AudioContent & { type: "audio" }): LangChainContentBlock {
    return {
      type: "audio",
      data: block.data,
      mimeType: block.mimeType,
   ...
   */
  private resourceLinkFromACP(block: ResourceLink & { type: "resource_link" }): LangChainContentBlock {
    return {
      type: "file",
      uri: block.uri,
      url: block.uri,
   ...
   */
  private embeddedResourceFromACP(block: EmbeddedResource & { type: "resource" }): LangChainContentBlock {
