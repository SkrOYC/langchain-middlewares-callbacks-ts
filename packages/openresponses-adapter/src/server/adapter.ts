...
import type { OpenResponsesHandlerOptions, OpenResponsesRequest, OpenResponsesResponse } from "../core/index.js";
...
export function createOpenResponsesAdapter(
	...
	return {
		async invoke(_request: OpenResponsesRequest): Promise<OpenResponsesResponse> {
