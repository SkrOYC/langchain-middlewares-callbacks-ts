 ...
 */
export function createTextFakeAgent(text: string): OpenResponsesCompatibleAgent {
 ...
 */
export function createStreamingFakeAgent(chunks: string[]): OpenResponsesCompatibleAgent {
	return createFakeAgent({
 ...
 */
export function createErrorFakeAgent(error: Error): OpenResponsesCompatibleAgent {
	return createFakeAgent({
		invokeError: error,
		streamError: error,
	});
