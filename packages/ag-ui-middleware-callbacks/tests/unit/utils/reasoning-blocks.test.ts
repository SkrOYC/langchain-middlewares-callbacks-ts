...
import {
  ...
  isReasoningBlock,
} from "../../../src/utils/reasoning-blocks";
...
class MockAIMessage {
  ...
  constructor(contentBlocks: MockContentBlock[]) {
...
describe("reasoningBlocks utility", () => {
  describe("isReasoningBlock", () => {
    ...
    test("returns false for null/undefined", () => {
      ...
      expect(isReasoningBlock(undefined)).toBe(false);
    });
  });
  ...
  describe("extractReasoningBlocks", () => {
    test("extracts reasoning blocks from AI message", () => {
      ...
      const blocks = extractReasoningBlocks(message as unknown as BaseMessage);
    ...
    test("handles messages without contentBlocks", () => {
      const message = { _getType: () => "ai" } as unknown as BaseMessage;
  ...
  describe("extractReasoningText", () => {
    test("extracts only reasoning text strings", () => {
      ...
      const texts = extractReasoningText(message as unknown as BaseMessage);
  ...
  describe("groupReasoningBlocksByIndex", () => {
    test("groups reasoning blocks by their index", () => {
      ...
      const grouped = groupReasoningBlocksByIndex(
        message as unknown as BaseMessage
      );
